...
class CatConfig(Config):
    ...
    NUM_CLASSES = 1 + 10  # Background + cat1 + cat2 + not_defined
...
class CatDataset(utils.Dataset):
    ...
    def load_cat(self, dataset_dir, subset):
        ...
        self.add_class("cat", 1, "m_swirl_arnold")
        self.add_class("cat", 2, "m_swirl_ghost")
        self.add_class("cat", 3, "m_swirl_lynxy")
        self.add_class("cat", 4, "m_swirl_sheila")
        self.add_class("cat", 5, "m_swirl_socksy")
        self.add_class("cat", 6, "m_swirl_spruce")
        self.add_class("cat", 7, "m_swirl_stubby")
        self.add_class("cat", 8, "m_tabby_cassidy")
        self.add_class("cat", 9, "m_tabby_murray")
        self.add_class("cat", 10, "other")
...
#                 polygons = [r['shape_attributes'] for r in a['regions']] 
            ...
            name_dict = {"m_swirl_arnold":1, "m_swirl_ghost":2, "m_swirl_lynxy":3, "m_swirl_sheila":4,
                         "m_swirl_socksy":5, "m_swirl_spruce":6, "m_swirl_stubby":7,"m_tabby_cassidy":8,"m_tabby_murray":9,"other":10}
