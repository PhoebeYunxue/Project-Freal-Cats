...
class CatConfig(Config):
    ...
    NUM_CLASSES = 1 + 7  # Background + cat1 + cat2 + not_defined
...
class CatDataset(utils.Dataset):
    ...
    def load_cat(self, dataset_dir, subset):
        ...
        self.add_class("cat", 1, "hotspur_swirl_1")
        self.add_class("cat", 2, "hotspur_swirl_2")
        self.add_class("cat", 3, "hotspur_swirl_3")
        self.add_class("cat", 4, "hotspur_tabby_1")
        self.add_class("cat", 5, "hotspur_tabby_2")
        self.add_class("cat", 6, "hotspur_tabby_3")
        self.add_class("cat", 7, "other")
...
#                 polygons = [r['shape_attributes'] for r in a['regions']] 
            ...
            name_dict = {"hotspur_swirl_1":1, "hotspur_swirl_2":2, "hotspur_swirl_3":3, "hotspur_tabby_1":4,
                         "hotspur_tabby_2":5, "hotspur_tabby_3":6, "other":7,"otway_tabby_vincent":76, "otway_tabby_stumpy":77, "otway_tabby_spatchcock":78, "otway_tabby_scoot":79,
                         "otway_tabby_roswell":80, "otway_tabby_pauline":81, "otway_tabby_patrick":82, "otway_tabby_patricia":83,
                         "otway_tabby_meg":84,"otway_tabby_jesus":85,"otway_tabby_javier":86,"otway_tabby_howard":87,"otway_tabby_hank":88,
                         ...
                         "annya_tabby_stumps":50,"c_black_mangy":51, "c_swirl_eskimo":52, "c_swirl_pattsy":53, "c_swirl_sprout":54,
                         "c_swirl_sterling":55, "c_swirl_willy":56, "c_tabby_brisket":57, "c_tabby_charlie":58, "c_tabby_quasimodo":59,"c_tabby_shelby":60,"c_tabby_sleuce":61,"m_swirl_arnold":67,
