...
# ROOT_DIR = "drive/Mask_RCNN_annya/"
ROOT_DIR = "./"
# Import Mask RCNN
...
class CatConfig(Config):
    ...
    NUM_CLASSES = 1 + 8  # Background + cat1 + cat2 + not_defined
...
class CatDataset(utils.Dataset):
    ...
    def load_cat(self, dataset_dir, subset):
        ...
        self.add_class("cat", 1, "annya_swirl_ben")
        self.add_class("cat", 2, "annya_swirl_gilbert")
        self.add_class("cat", 3, "annya_swirl_lola")
        self.add_class("cat", 4, "annya_swirl_motley")
        self.add_class("cat", 5, "annya_tabby_danny")
        self.add_class("cat", 6, "annya_tabby_joe")
        self.add_class("cat", 7, "annya_tabby_stumps")
        self.add_class("cat", 8, "other")
...
#                 polygons = [r['shape_attributes'] for r in a['regions']] 
            ...
            name_dict = {"annya_swirl_ben":1, "annya_swirl_gilbert":2, "annya_swirl_lola":3, "annya_swirl_motley":4, "annya_tabby_danny":5, "annya_tabby_joe":6, "annya_tabby_stumps":7, "other":8 }
