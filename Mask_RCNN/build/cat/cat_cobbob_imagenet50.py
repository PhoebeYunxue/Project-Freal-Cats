...
class CatConfig(Config):
    ...
    NUM_CLASSES = 1 + 12  # Background + cat1 + cat2 + not_defined
...
class CatDataset(utils.Dataset):
    ...
    def load_cat(self, dataset_dir, subset):
        ...
        self.add_class("cat", 1, "c_black_mangy")
        self.add_class("cat", 2, "c_swirl_eskimo")
        self.add_class("cat", 3, "c_swirl_pattsy")
        self.add_class("cat", 4, "c_swirl_sprout")
        self.add_class("cat", 5, "c_swirl_sterling")
        self.add_class("cat", 6, "c_swirl_willy")
        self.add_class("cat", 7, "c_tabby_brisket")
        self.add_class("cat", 8, "c_tabby_charlie")
        self.add_class("cat", 9, "c_tabby_quasimodo")
        self.add_class("cat", 10, "c_tabby_shelby")
        self.add_class("cat", 11, "c_tabby_sleuce")
        self.add_class("cat", 12, "other")
...
#                 polygons = [r['shape_attributes'] for r in a['regions']] 
            ...
            name_dict = {"c_black_mangy":1, "c_swirl_eskimo":2, "c_swirl_pattsy":3, "c_swirl_sprout":4,
                         "c_swirl_sterling":5, "c_swirl_willy":6, "c_tabby_brisket":7, "c_tabby_charlie":8,
                         "c_tabby_quasimodo":9,"c_tabby_shelby":10,"c_tabby_sleuce":11,"other":12,"otway_tabby_vincent":76, "otway_tabby_stumpy":77, "otway_tabby_spatchcock":78, "otway_tabby_scoot":79,
                         "otway_tabby_roswell":80, "otway_tabby_pauline":81, "otway_tabby_patrick":82, "otway_tabby_patricia":83,
                         "otway_tabby_meg":84,"otway_tabby_jesus":85,"otway_tabby_javier":86,"otway_tabby_howard":87,"otway_tabby_hank":13,
                         ...
                         "annya_swirl_ben":44, "annya_swirl_gilbert":45, "annya_swirl_lola":46, "annya_swirl_motley":47, "annya_tabby_danny":48, "annya_tabby_joe":49,
                         "annya_tabby_stumps":50,"hotspur_swirl_1":61, "hotspur_swirl_2":62, "hotspur_swirl_3":63, "hotspur_tabby_1":64,"hotspur_tabby_2":65, "hotspur_tabby_3":66, "m_swirl_arnold":67,
                         "m_swirl_ghost":68, "m_swirl_lynxy":69, "m_swirl_sheila":70,"m_swirl_socksy":71, "m_swirl_spruce":72, "m_swirl_stubby":73,"m_tabby_cassidy":74,"m_tabby_murray":75}
